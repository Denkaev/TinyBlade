...
public class BFMove : MonoBehaviour
{
    ...
    {
        //один раз срабатывает по стрелкам. если убрать стрелки из управления, то во всем проекте не будет работать, поэтому не подходит.
        //Надо тут как-то отлавливать или реагировать только на нажатие кнопок
        if (y > 0)
            if (moveUnit)
            {
